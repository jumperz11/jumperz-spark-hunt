# JUMPERZ Hunt Submission

Use this packet when sharing JUMPERZ with Spark Compete reviewers.
...
- Packet 023: Outcome command records unknown in non-interactive mode
  - https://github.com/jumperz11/jumperz-spark-hunt/blob/main/packets/023-outcome-noninteractive-records-unknown.md
- Packet 024: Memory config missing traceback
  - https://github.com/jumperz11/jumperz-spark-hunt/blob/main/packets/024-memory-config-missing-traceback.md
...
- Packet 028: EIDOS purge dry run creates store
  - https://github.com/jumperz11/jumperz-spark-hunt/blob/main/packets/028-eidos-purge-dry-run-creates-store.md
- Packet 029: EIDOS stats creates store
  - https://github.com/jumperz11/jumperz-spark-hunt/blob/main/packets/029-eidos-stats-creates-store.md
- Packet 030: EIDOS validate migration creates store
  - https://github.com/jumperz11/jumperz-spark-hunt/blob/main/packets/030-eidos-validate-migration-creates-store.md
- Packet 031: EIDOS list views create store
  - https://github.com/jumperz11/jumperz-spark-hunt/blob/main/packets/031-eidos-list-views-create-store.md
...
- Packet 038: CLI view commands emit mojibake
  - https://github.com/jumperz11/jumperz-spark-hunt/blob/main/packets/038-cli-view-commands-mojibake.md
...
- Packet 070: Logs tail bounds ignored
  - https://github.com/jumperz11/jumperz-spark-hunt/blob/main/packets/070-logs-tail-bounds.md
...
The competition website registration field accepts a GitHub user/profile identity, so the site registration uses `https://github.com/jumperz11`.

The clean repo above is the proof hub for reviewer routing.
