...
Last checked: 2026-05-29 12:22 UTC
...
| Domain-chip local test collection | `spark-domain-chip-labs` | PR #24 covers optional `jsonschema` collection failures in six schema-focused modules. | Avoid duplicating importorskip work; only pursue the saved-fixture mismatch if it proves to be a real user-facing or reviewer-blocking failure. |
