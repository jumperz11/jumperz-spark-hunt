...
Last checked: 2026-05-29 14:34 UTC
...
| [#21](https://github.com/vibeforge1111/spark-voice-comms/pull/21) | `spark-voice-comms` | Open, ready for review, mergeable; GitHub shows unstable check state, no comments | Valid: `packet_valid=true`, `can_continue_to_review=true`, 0 errors/warnings | Transcribe tests -> 7 passed; non-Kokoro Python 3.14 suite -> 37 passed, 4 known Kokoro tests deselected; `py_compile` passed; invalid-audio smoke returns direct base64 error | Watch for maintainer feedback. This is a focused `voice.transcribe` audio input-boundary lane, separate from #19 Kokoro Python support and #20 invalid JSON shape handling. |
